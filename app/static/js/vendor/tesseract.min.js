/*! Vendored verbatim from https://cdn.jsdelivr.net/npm/tesseract.js@5.1.1/dist/tesseract.min.js
 * (Apache-2.0, see https://github.com/naptha/tesseract.js/blob/master/LICENSE.md), fetched 2026-09-01.
 * Do not load this from a CDN - see app/static/js/label-scan.js for why (Phase 9 Part 3: the shop's
 * internet is unreliable, and this must work with zero configuration/no network dependency).
 * Sets window.Tesseract when loaded via a plain <script> tag. */
